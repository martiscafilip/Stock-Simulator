			...
			<form action="../../app/controllers/registervalidate.php" method="POST">
				...
				<div class="form_wrap">
					<div class="input_wrap">
						...
						<input name="fullname" type="text" id="fname" required type="text">
					</div>
					<div class="input_wrap">
						<label for="username">Username</label>
						<input name="username" type="text" id="username" required type="text">
					</div>
					<div class="input_wrap">
						<label for="email">Email Address</label>
						<input name="email" type="text" id="email" required type="email">
					</div>
					<div class="input_wrap">
						<label for="password">Password</label>
						<input name="password" type="password" id="password" required type="password">
					</div>
					<div class="input_wrap">
